        ...
        <div className="flex z-10 w-full items-center gap-8 ">
          <div className="flex flex-col max-w-md gap-6 w-full">
            ...
            <div className="flex items-center gap-3 min-w-5xl">
              <button className="flex items-center gap-1 group bg-gradient-to-tl from-[#377ef4] via-[#2563eb] to-[#3b82f6] hover:brightness-110 px-4 py-3 font-grotesk-medium font-medium text-sm rounded-lg shadow-lg cursor-pointer">
                Start Free Trial
                <ArrowRight
              ...
              <button className="bg-white px-4 py-3 text-black font-grotesk-medium text-sm shadow-lg font-medium rounded-lg cursor-pointer hover:bg-gray-50">
                Learn More
              </button>
            </div>
          </div>
